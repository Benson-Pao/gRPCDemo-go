...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*CreateUserResponse, error) {
...
func (c *userServiceClient) GetList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListResponse, error) {
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *UserInfo) (*CreateUserResponse, error) {
...
func _UserService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetList(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
